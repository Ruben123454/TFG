...
TinyBVHD_GPU TinyBVH::obtenerDatosGPU() const { return datos_gpu; }

const TinyBVHD_GPU* TinyBVH::getNodosGPU() const { return &datos_gpu; }

const Primitiva* TinyBVH::getPrimitivasGPU() const { return primitivas_gpu; }

unsigned int TinyBVH::getNumNodos() const { return static_cast<BVH8_CWBVH*>(cwbvh_ptr)->usedBlocks; }

unsigned int TinyBVH::getNumPrimitivas() const { return num_primitivas_gpu; }